...
auto main(int argc, char* argv[]) -> int {
    ...
    if(parser_type == Z_PARSER || parser_type == K_PARSER || parser_type == E_PARSER) { round_costs = false; }

    auto maybe_instance = parser_type == X_PARSER ? cobra::Instance::make<cobra::XInstanceParser, true>(arg_parser.get_instance_path()) :
                           (parser_type == Z_PARSER ? cobra::Instance::make<cobra::ZKInstanceParser, false>(arg_parser.get_instance_path()) :
                           (parser_type == E_PARSER ? cobra::Instance::make<cobra::EInstanceParser, false>(arg_parser.get_instance_path()) :
